    ...
    return (
        <div>
            ...
            <Container fluid>
                ...
                <Row>
                    <h3>Register for an account</h3><br></br><br></br>
                    <p>To make use of our app, you'll need to register for an account. It's free, and you won't regret it.</p>
                    <Registration />
                </Row>
            </Container>
